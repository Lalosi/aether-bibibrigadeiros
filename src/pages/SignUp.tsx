    ...
    <div className="min-h-screen flex items-center justify-center bg-confectionery-pink/10 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm p-8 animate-scale-in">
          ...
          <h1 className="text-2xl font-semibold text-center mb-2">Crie uma conta</h1>
          <p className="text-gray-500 text-center mb-6">Comece sua jornada de 30 dias grátis!</p>
